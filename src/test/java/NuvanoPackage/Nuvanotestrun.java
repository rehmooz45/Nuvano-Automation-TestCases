...
class Nuvanotestrun {
    ...
    // NuvanoSignin.Login(Prop.getProperty("USERNAME1"),
    // Prop.getProperty("PASSWORD1"));
    // //****Verification****
    // String text = NuvanoSignin.waitForVisibility(By.xpath("//h1[text() = 'Smart
    // Resource Scheduling']")).getText();
    ...
    @Test(priority = 6, description = "Login with empty email and empty password")
